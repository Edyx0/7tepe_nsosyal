...
const trendPostTokens: Record<string, string[]> = { "#serinrota": ["gölge", "durak", "çeşme", "serin"], "#acikveri": ["veri", "harita", "güncel"], "#sessizsinema": ["film", "sinema", "gösterim"], "#gecekutuphanesi": ["gece", "kütüphane", "güvenli"], "#kaldirimhakki": ["kaldırım", "erişilebilir", "yaya"], "#sokaksesleri": ["ses", "sokak", "vapur"] };
