  ...
  return <main className="app-shell">
    ...
    <section className="timeline" aria-label={title}>
       ...
       <div id="main-content" className="content-area">
        ...
        {view === "profile" && <Profile {...feedProps} profile={visibleProfile} isOwn={isOwnProfile} posts={profilePosts} morePost={morePost} onEdit={() => setEditingProfile(true)} onMessage={openMessages} />}
...
function CompactDesktopMenu({ view, setView, theme, setTheme, profile, onClose, onOwnProfile, onCompose }: { view: View; setView: (view: View) => void; theme: Theme; setTheme: (theme: Theme) => void; profile: Profile; onClose: () => void; onOwnProfile: () => void; onCompose: () => void }) {
  ...
  const navigate = (next: View) => { if (next === "profile") onOwnProfile(); else setView(next); onClose(); };
...
function Profile(props: FeedProps & { profile: Profile; isOwn: boolean; onEdit: () => void; onMessage: (profile: Profile) => void }) {
