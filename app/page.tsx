...
export default function Home() {
  ...
  function createPost(event: FormEvent<HTMLFormElement>) {
    ...
    setDraftPosts((current) => [post, ...current]); setComposerText(""); setComposerMedia(false); setReplyingTo(null); setComposerOpen(false); setNotice("Gönderi Ana Sayfa'ya eklendi."); setView("feed");
  }
